...
function newsFeed() {
  ...
  template = template.replace("{{__next_page__}}", String(store.currentPage < store.limit ? store.currentPage + 1 : store.limit));
  updateView(template);
}
...
},{}]},{},["../../../../../.nvm/versions/node/v16.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
