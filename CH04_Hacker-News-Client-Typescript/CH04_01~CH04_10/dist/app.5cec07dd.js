...
function () {
  ...
  Router.prototype.route = function () {
    var routePath = location.hash; // location.hash 에 '#'만 있을 경우, 빈 값('')을 반환함.
    ...
    for (var _i = 0, _a = this.routeTable; _i < _a.length; _i++) {
      ...
      if (routePath.indexOf(routeInfo.path) >= 0) {
        if (routeInfo.params) {
          var parserParams = routePath.match(routeInfo.params);
  ...
  function NewsDetailView(containerId, store) {
    ...
    _this.render = function (id) {
      return __awaiter(_this, void 0, Promise, function () {
        var api, _a, comments, title, content;
...
function (_super) {
  ...
  function NewsFeedView(containerId, store) {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 2:
              ...
              this.store.limit = Math.ceil(this.store.getAllFeedsLength() / this.store.offset);

              for (i = (this.store.currentPage - 1) * this.store.offset; i < this.store.currentPage * this.store.offset; i++) {
    ...
    return _this; // this.feeds = window.store.feeds;
  }
...
function () {
  ...
  Object.defineProperty(Store.prototype, "limit", {
    get: function get() {
      return this._limit;
    },
  ...
  Store.prototype.getAllFeedsLength = function () {
    return this.feeds.length;
  };
...
router.go();
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts","./store":"src/store.ts"}],"../../../../../.nvm/versions/node/v16.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../.nvm/versions/node/v16.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
